...
Today we will use the annotation package method. A workflow for annotation with biomaRt is included in the extended materials section acessible on the course website.
