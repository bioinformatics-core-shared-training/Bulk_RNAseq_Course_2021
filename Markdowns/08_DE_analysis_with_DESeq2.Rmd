...
XXXXXXXXXXXX AAAAAAAAAAARRRGHHHH THAT DOESN'T DEMO WHAT WE WANT !!!!!!! XXXXXXXXXXXXXXXX
...
ddsObj2 <- DESeq(ddsObj2.filt)

# Compare the two designs
ddsObjC2 <- DESeq(ddsObj2, test="LRT", reduced=additive.model)
resCSvCxS <- results(ddsObjC2)
table(resCSvCxS$padj < 0.05)

# Compare the two designs
ddsObjC2 <- DESeq(ddsObj2, test="LRT", reduced=simple.model)
resCSvCxS <- results(ddsObjC2)
table(resCSvCxS$padj < 0.05)
```
