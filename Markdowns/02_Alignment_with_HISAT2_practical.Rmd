...
what all the name of these files will start with. e.g is the 'basename' we give
...
>    There should be file called `Mus_musculus.GRCm38.chr14.fa`. This is the
