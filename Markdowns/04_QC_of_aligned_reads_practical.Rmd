...
**XXXXXXXXXX NEED TO MODIFY FOR PE XXXXXXXXXX**
...
**WE WILL USE A BAM WITH ONLY CHR1 for speed: SRR7657883.chr1.sorted.bam**
...
>          OUTPUT=bam/SRR7657883.chr1.mkdup.bam \
>          METRICS_FILE=bam/SRR7657883.chr1.mkdup_metrics.txt \
>          CREATE_INDEX=true
> ```
...
**NEED TO CREATE SOME PROBLEMATIC SAMPLES**
