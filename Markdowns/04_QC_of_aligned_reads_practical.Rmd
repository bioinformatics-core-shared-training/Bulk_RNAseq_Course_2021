...
only contains reads aligned to chromosome 1. Running each tool on the full bam
file would take too long for the practical. You should find afile called
`SRR7657883.chr1.sorted.bam` under the directory `bam`, please use this rather
