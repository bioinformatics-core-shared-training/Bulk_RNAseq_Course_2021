...
<!--- rmarkdown::render("/Volumes/Files/courses/cruk/RNAseqWithR/202103/tex/sc/StatsRNAseq_Couturier+.Rmd") --->
...
cbind(inf,X1%*%c(2,3,4),X2%*%c(2,1,2),X3%*%c(4,-2,-1))
...
# ! CHALLENGE !
# ! FIND the values of the BETA vector corresponding to X1, X2 and X3 !
cbind(inf,X1%*%c(2,1,2),X2%*%c(2,1,2,1))
