...
The data for this course comes from a Frontiers in Microbiology paper, [Transcriptomic Profiling of Mouse Brain During Acute and Chronic Infections by Toxoplasma gondii Oocysts*](https://www.frontiersin.org/articles/10.3389/fmicb.2020.570903/full) [@Hu2020]. 
...
```
for sraAcc in `cat accessoryFiles/SRR_Acc_List.txt`; do
  prefetch ${srrAcc}  
done
```
