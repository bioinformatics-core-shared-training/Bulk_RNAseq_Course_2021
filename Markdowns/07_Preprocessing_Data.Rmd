...
BRIEF DESCRIPTION OF THE DATASET - paper, GEO, SRA [@Hu2020]

Please see extended material for instructions on 
[downloading raw files from SRA](S1_Getting_raw_reads_from_SRA.html).
...
*salmon* directory. To this we use the `tximport` function. We need to create
...
to gene level. To this we need a table that related transcript 
